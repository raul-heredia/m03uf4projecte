...
public class ReservaL {
    ...
    public static void prestarLibro(ArrayList libros, ArrayList clientes, ArrayList reservaLibros, String ISBN, String nif){
        Boolean isUsuario =false, isLibro =false, isPrestadoLibro = false, isUsuarioConPrestamo =false, tienePuntos = false;
        ...
        if (isUsuario && isLibro && tienePuntos){
            ...
            if(!isLibro) System.out.println("Error, no existe ningun libro con ISBN: " + ISBN);
        }
    }
